...
<!--                    </template>-->
<!--                </el-table-column>-->
                <el-table-column prop="health_status" label="健康状况"></el-table-column>
                <el-table-column prop="risk_level" label="感染风险"></el-table-column>
...
<!--                        <el-option key="1" label="待审核" value="待审核"></el-option>-->
                ...
                <el-form-item label="审核意见">
                    <el-input v-model="form.auditOpinion"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        // 获取数据
        getData() {
            this.$axios.get('/Bluetooth/getUserInfoListNot0').then(resp =>{
                 console.log(resp)
