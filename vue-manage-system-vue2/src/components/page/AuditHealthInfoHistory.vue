    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 用户健康信息审核记录
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<!--                <el-table-column prop="action" label="地址"></el-table-column>-->
                ...
                <el-table-column prop="auditStatus" label="审核状态">
                    <template slot-scope="scope">
                        <el-tag
                                :type="scope.row.auditStatus==='通过'?'success':'danger'"
...
export default {
    ...
    methods: {
        ...
        // 获取数据
        getData() {
            this.$axios.get('/Bluetooth/findHealthInfoListByStatus?healthStatus=已审核').then(resp =>{
                 console.log(resp)
